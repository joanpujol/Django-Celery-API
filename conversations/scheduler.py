...
class ChatScheduler:
    ...
    def schedule_dispatch(self, chat_instance):
        ...
        user_tz = current_conversation.user.timezone
    ...
    def _search_available_timeslot(self, user_tz, store_tz):
        ...
        while messages_per_hour >= max_messages_per_hour:
            if self._is_within_sending_interval(start_hour, user_tz, store_tz):
    ...
    def _is_within_sending_interval(self, dt, user_tz, store_tz):
        reference_tz = user_tz or store_tz
